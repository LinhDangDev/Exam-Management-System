...
public partial class ApplicationDbContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Server=DESKTOP-URQSHUO\\SQLEXPRESS;Database=TracNghiem_HUTECH;Trusted_Connection=True;TrustServerCertificate=True;Max Pool Size=200;");
